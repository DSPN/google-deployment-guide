...
## IMPORTANT NOTE
There are minimum cluster requirements that MUST be met for the deployment to succeed. Please ensure you have a cluster meeting these minimums before deploying. The requirements are <span style="color:red">**5 nodes of instance type n1-standard-4 with at least 60GB of disk size for each DSE node**</span>.
